...
class FitoadminController extends Controller
{
    ...
    public function workout_plan()
    {
        ...
        return view('dashboard.workout_plan', compact('page_title', 'page_description','action','logo','logoText'));
    }
    ...
    public function widget_basic()
    {
        ...
        // Categorias
             public function category_menu()
             {
                 ...
                 return view('dashboard.category', compact('page_title', 'page_description','action','logo','logoText'));
             }
         ...
         public function favourites_menu()
         {
             ...
             return view('dashboard.favourites', compact('page_title', 'page_description','action','logo','logoText'));
         }
          ...
          public function layout()
          {
              ...
              return view('layout', compact('page_title', 'page_description','action','logo','logoText'));
          }
